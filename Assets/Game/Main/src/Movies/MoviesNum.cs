...
public class MoviesNum : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //何の動画を選択か
        switch(Buttonnum){
            case 0:buttontext.text = "NoSelect";
            break;

            case 1: buttontext.text = "" + MoviesName[Buttonnum];
            break;

            case 2:buttontext.text = "" + MoviesName[Buttonnum];
            break;

            case 3:buttontext.text = "" + MoviesName[Buttonnum];
            break;

            case 4:buttontext.text = "" + MoviesName[Buttonnum];
            break;

            case 5:buttontext.text = "" + MoviesName[Buttonnum];
            break;

            default:buttontext.text = "Error";
            break;
        }
    }
}
